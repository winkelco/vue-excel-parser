export default {
  ...
  es: {
    ...
    submit: 'Enviar',
    close: 'OK',
    columnData: 'Información por columna',
    chooseColumn: 'Escoja una columna',
    selected: 'Seleccionado',
    select: 'Seleccionar',
    selectColumn: 'Porfavor escoja una columna',
    file: {
      select: 'Por favor seleccione un archivo',
      tryAgain: 'Escoja otro archivo',
      withHeaders: 'Este archivo incluye encabezados',
      withoutHeaders: 'Este archivo no incluye encabezados',
    },
    error: {
      title: 'Error',
      columnNumber:
        'El archivo na tiene las columnas necesarias. <br><b>Columnas necesarias: </b>: ',
      missingColumns: 'Faltan columnas:',
      selectColumn: 'Es necesario seleccionar todas las columnas',
      fileNumber: 'Por favor selecciona un archivo',
      fileSelection: 'No has seleccionado ningun archivo',
      invalidFile: 'Este archivo es invalido. Usa un archivo CSV o XLSX',
      noWorksheet: 'Debe tener por lo menos una hoja',
      emptyWorksheet: 'Esta hoja esta vacia',
    },
  },
  ptBR: {
    column: 'Coluna',
